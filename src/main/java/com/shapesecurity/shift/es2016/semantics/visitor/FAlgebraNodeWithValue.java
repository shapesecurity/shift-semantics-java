...
public interface FAlgebraNodeWithValue<T> {
    @Nonnull T apply(BlockWithValue blockWithValue);
    @Nonnull T apply(Call call);
    @Nonnull T apply(DeleteGlobalProperty deleteGlobalProperty);
    @Nonnull T apply(DeleteProperty deleteProperty);
    @Nonnull T apply(GlobalReference globalReference);
    @Nonnull T apply(Halt halt);
    @Nonnull T apply(Keys keys);
    @Nonnull T apply(LiteralBoolean literalBoolean);
    @Nonnull T apply(LiteralEmptyArray literalEmptyArray);
    @Nonnull T apply(LiteralEmptyObject literalEmptyObject);
    @Nonnull T apply(LiteralFunction literalFunction);
    @Nonnull T apply(LiteralInfinity literalInfinity);
    @Nonnull T apply(LiteralNull literalNull);
    @Nonnull T apply(LiteralNumber literalNumber);
    @Nonnull T apply(LiteralRegExp literalRegExp);
    @Nonnull T apply(LiteralString literalString);
    @Nonnull T apply(LiteralSymbol literalSymbol);
    @Nonnull T apply(LiteralUndefined literalUndefined);
    @Nonnull T apply(MemberAccess memberAccess);
    @Nonnull T apply(MemberAssignment memberAssignment);
    @Nonnull T apply(New new_);
    @Nonnull T apply(RequireObjectCoercible requireObjectCoercible);
    @Nonnull T apply(LocalReference localReference);
    @Nonnull T apply(TemporaryReference temporaryReference);
    @Nonnull T apply(This this_);
    @Nonnull T apply(TypeCoercionNumber typeCoercionNumber);
    @Nonnull T apply(TypeCoercionString typeCoercionString);
    @Nonnull T apply(TypeofGlobal typeofGlobal);
    @Nonnull T apply(VariableAssignment variableAssignment);
    @Nonnull T apply(Equality equality);
    @Nonnull T apply(FloatMath floatMath);
    @Nonnull T apply(In in_);
    @Nonnull T apply(InstanceOf instanceOf);
    @Nonnull T apply(IntMath intMath);
    @Nonnull T apply(Logic logic);
    @Nonnull T apply(RelationalComparison relationalComparison);
    @Nonnull T apply(BitwiseNot bitwiseNot);
    @Nonnull T apply(Negation negation);
    @Nonnull T apply(Not not);
    @Nonnull T apply(Typeof typeof);
    @Nonnull T apply(VoidOp voidOp);
}
