...
import com.shapesecurity.shift.es2017.semantics.asg.UnaryOperation.UnaryOperation;
...
public class Dottifier {
	...
	private String reduce(Node node) {
		...
		if (node instanceof BinaryOperation) {
			...
			return reduceVoid((com.shapesecurity.shift.es2017.semantics.asg.Void) node);
		}
